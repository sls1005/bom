...
Therefore, the best way to work with the byte order mark isn't to totally accept or avoid using it, but to use it when needed and avoid it if possible (or to use it if possible and avoid it if necessary). That's why I made this tool.
